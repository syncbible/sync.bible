...
function getStrongsColorWithSettings(
	strongsNumber,
	highlightWordsWith,
...
function getHighlight(
	...
	var newColor = getStrongsColorWithSettings(
		strongsNumber,
		highlightWordsWith,
		strongsObjectWithFamilies
	);
	var className = getClassNameWithSettings(
		strongsNumber,
		highlightWordsWith,
		strongsObjectWithFamilies
	);
...
function getHighlightBorder(
	...
	return (
		'.' + className + ' {outline: 3px solid ' + newColor + ' !important;}'
	);
}
